...
export const searchVendors = async (keyword: string, location: string) => {
  ...
  try {
    const response = await axios.post(
      ...
      [{ keyword: `${keyword} ${location}`, location_code: 2372, language_code: 'en', device: 'desktop', os: 'windows', depth: 100 }],
      { headers: { Authorization: `Basic ${auth}` } }
    );
...
export const getAllRegions = async () => {
  // Implement this function to return all regions
  // This should be a relatively fast operation, possibly reading from a JSON file
};

export const getAllVenueTypes = async () => {
  // Implement this function to return all venue types
  // This should be a relatively fast operation, possibly reading from a JSON file
};

export const getAllVendorCategories = async () => {
  // Implement this function to return all vendor categories
  // This should be a relatively fast operation, possibly reading from a JSON file
};
